...
class NotificationsMock
{
    ...
    public:
        NotificationsMock (std::vector<std::string> capabilities = {"actions", "body", "body-markup", "icon-static", "image/svg+xml", "x-ayatana-private-synchronous", "x-ayatana-append", "x-ayatana-private-icon-only", "x-ayatana-truncation", "private-synchronous", "append", "private-icon-only", "truncation"}) {
